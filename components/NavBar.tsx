...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    label: "MY DONATION",
    dropdown: [
      { label: "My Payments", href: "/myPayment" },
      { label: "My Monthly Donation", href: "/monthlyDonation" },
      { label: "Consolidated Receipts", href: "/consolidatedReceipts" },
    ],
  },
  ...
  return (
    <>
      ...
      <nav className="hidden md:block bg-[#063D8E] text-white shadow">
        <div className="w-full lg:max-w-8xl mx-auto flex items-center justify-center gap-8 px-2 h-11 text-sm font-normal">
          {NAV_ITEMS.map((item) => (
